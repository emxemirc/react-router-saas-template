...
describe("getImageSource", () => {
  ...
  describe("given: request with Supabase Storage URL", () => {
    const validStorageUrl = `${TEST_SUPABASE_URL}/storage/v1/object/public/app-images/user-avatars/abc123.png`;
    ...
    test("should: reject private storage URLs", async () => {
      ...
      const privateUrl = `${TEST_SUPABASE_URL}/storage/v1/object/app-images/avatar.png`;
    ...
    test("should: reject unauthorized bucket", async () => {
      const unauthorizedBucketUrl = `${TEST_SUPABASE_URL}/storage/v1/object/public/unauthorized-bucket/file.png`;
    ...
    test("should: reject invalid file extension in Storage URL", async () => {
      const invalidExtUrl = `${TEST_SUPABASE_URL}/storage/v1/object/public/app-images/user-avatars/malware.exe`;
    ...
    test("should: reject malformed Storage URL", async () => {
      const malformedUrl = `${TEST_SUPABASE_URL}/storage/v1/object/public/`;
